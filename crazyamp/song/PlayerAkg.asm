...
dknr3:  ld bc,#f401                     ;C is the PSG register.
        ...
        IFNDEF PLY_AKG_Rom
dknr3:
PLY_AKG_PSGReg01_InstrDisarkGenerateExternalLabel:
PLY_AKG_PSGReg01_Instr: ld hl,0
        ...
        IFNDEF PLY_AKG_Rom
dknr3:
PLY_AKG_PSGReg23_InstrDisarkGenerateExternalLabel:
PLY_AKG_PSGReg23_Instr: ld hl,0
        ...
        IFNDEF PLY_AKG_Rom
dknr3:
PLY_AKG_PSGReg45_InstrDisarkGenerateExternalLabel:
PLY_AKG_PSGReg45_Instr: ld hl,0
        ...
        IFNDEF PLY_AKG_Rom
dknr3:
PLY_AKG_PSGReg6_8_InstrDisarkGenerateExternalLabel:
...
PLY_AKG_PSGReg8: equ PLY_AKG_PSGReg8_Instr + 1
        ...
        IFNDEF PLY_AKG_Rom
dknr3:
PLY_AKG_PSGReg9_10_InstrDisarkGenerateExternalLabel:
